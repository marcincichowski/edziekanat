...
class UserManager(BaseUserManager):
    def create_user(self, email, password, role, phone, address, birth_date, allow_email_send=None, extra=None, **extra_fields):
        if not email:
        ...
        extra_fields.setdefault('birth_date', birth_date)
